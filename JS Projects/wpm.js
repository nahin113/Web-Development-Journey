document.addEventListener("DOMContentLoaded", () => {
  ...
  function restartTest() {
    ...
    // Reset UI
    time.innerText = "Time: 60s";
    wpm.innerText = "Words Per Minute: 0";
    accuracy.innerText = "Accuracy: 100%";
    paragraph.classList.remove("hidden");
    document.querySelector("#info").classList.remove("middle");
    document
  ...
  function updateStats() {
    ...
    if (cnt == 0) {
      ...
      document.querySelectorAll("div p").forEach((p) => p.classList.add("highlight"));
